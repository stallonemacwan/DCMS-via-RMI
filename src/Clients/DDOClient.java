...
public class DDOClient {
    ...
    public void run(String managerID, Log LogObject) {
        try {
            ...
            CenterServer mtl = (CenterServer) registry.lookup("DDO");
            ...
            while (true) {
                ...
                switch (ch) {
                    ...
                    case 6:
                        ...
                        if (canBind("localhost", 4568)) {
                            System.out.println("Laval Server was not running, so running it now to get the record count.");
